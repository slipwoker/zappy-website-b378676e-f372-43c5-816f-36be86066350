    ...
    contactForm.addEventListener('submit', async function(e) {
      ...
      if (!window.zappyContactFormLoaded) {
        try {
          ...
          const zappyPayload = {
            websiteId: 'b378676e-f372-43c5-816f-36be86066350',
            name: fullName,
            email: email,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "TEAM DR JOSEPH משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
